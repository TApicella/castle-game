...
def main():
    ...
    parser.add_argument("-width", "-w", default=100, type=int, dest="width",
            help="The width of the generated image - default is 300")
    parser.add_argument("-height", "-he", default=100, type=int, dest="height",
            help="The height of the generated image - default is 300")
    ...
    parser.add_argument("-number-of-seeds", "-n", default=25, type=int,
